   ...
   exit();
	...
	if($resultado->num_rows > 0 ){
		...
		if (PHP_SAPI == 'cli'){
			...
			$tituloReporte = "Seguros por Pasajero con Fecha de Salida entre: ".$fecha_desde." y ".$fecha_hasta;
			...
			//$objWriter->save('documentos/seguros/Seguros_pasajeros_pruebas_de_guardado.xlsx');
