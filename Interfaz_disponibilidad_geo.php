<?php
	...
	require 'clases/interfaz_disponibilidad_geo.cls.php';
	...
	if(count($_POST) != 0){
		...
		if($parametros['ir_a'] != 'S'){
			...
			$oInterfaz_disponibilidad = new clsInterfaz_disponibilidad_geo($conexion, $filadesde, $usuario, $parametros['buscar_interfaz'], $parametros['buscar_pais'], $parametros['buscar_provincia'], $parametros['buscar_poblacion'], $parametros['buscar_categoria'], $parametros['buscar_fecha_entrada'], $parametros['buscar_fecha_salida'], $parametros['buscar_hotel'], $parametros['buscar_habitaciones'], $parametros['buscar_adultos'], $parametros['buscar_ninos'], $parametros['buscar_longitud'], $parametros['buscar_latitud'], $parametros['buscar_radio_km']);
			...
			/*if($parametros['actuar'] == 'S'){
				...
				for ($num_fila = 0; $num_fila <= $vueltas-1; $num_fila++) {
					if($parametros['selec'.$num_fila] == 'S' ){
						...
						$Interfaz_disponibilidad = new clsInterfaz_disponibilidad_geo($conexion, $filadesde, $usuario, $parametros['buscar_interfaz'], $parametros['buscar_provincia'], $parametros['buscar_poblacion'], $parametros['buscar_categoria'], $parametros['buscar_fecha_entrada'], $parametros['buscar_fecha_salida'], $parametros['buscar_hotel']);
			...
			$comboPaises = $oCombos->Cargar_combo_Paises_ISO2();
			...
			$smarty->assign('formulario', '» DISPONIBILIDAD - GEOLOCALIZACION');
			...
			$smarty->assign('buscar_longitud', $parametros['buscar_longitud']);
			$smarty->assign('buscar_latitud', $parametros['buscar_latitud']);
			$smarty->assign('buscar_radio_km', $parametros['buscar_radio_km']);
			$smarty->assign('alojamientos_sistema', $parametros['alojamientos_sistema']);

			$smarty->display('plantillas/Interfaz_disponibilidad_geo.html');
		...
		$parametros['buscar_longitud'] = "";
		$parametros['buscar_latitud'] = "";
		$parametros['buscar_radio_km'] = "";
