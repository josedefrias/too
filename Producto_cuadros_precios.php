<?php
	...
	require 'clases/producto_cuadros_precios.cls.php';
	...
	$parametrosg = $_GET;
			...
			$recuperaprecio = ''; 
			$mensaje1_precios_precios = '';
			$mensaje2_precios_precios = '';
			$error_precios_precios = '';
...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	$ClasePrecios = new clsCuadros_precios($conexion, $filadesde, $usuario, $parametros['buscar_codigo'], $parametros['buscar_cuadro']);
...
//----------------------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------
			...
			//Llamada a la clase especifica de la pantalla
			$sCalendario_cabecera = $ClasePrecios->Cargar_calendario_cabecera($sCuadros[0]['clave']);

			$sPrecios_paquete = $ClasePrecios->Cargar_precios($sCuadros[0]['clave'], $parametros['buscar_ciudad'], $parametros['buscar_paquete']);
	
			//Llamada a la clase general de combos
			$comboCiudades = $combos->Cargar_combo_Cuadros_Precios_Ciudades($sCuadros[0]['clave']);
			$comboPaquetes = $combos->Cargar_combo_Cuadros_Paquetes_Agrupados($sCuadros[0]['clave']);
...
//----------------------------------------------------------------------------------------------------------------------------------------------
			...
			$smarty->assign('formulario', '» PRECIOS');
...
//----------------------------------------------------------------------------------------------------------------------------------------------
			...
			//Cargar lineas de la tabla para visualizar modificar o borrar
			$smarty->assign('calendario_cabecera', $sCalendario_cabecera);
			$smarty->assign('precios', $sPrecios_paquete);
			...
			$smarty->display('plantillas/Producto_cuadros_precios.html');
