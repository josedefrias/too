...
class clsAeropuertos{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo, nombre,ciudad
									  FROM hit_aeropuertos ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'AEROPUERTOS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'AEROPUERTOS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_aeropuertos'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $ciudad){

		$conexion = $this ->Conexion;
		$query = "UPDATE hit_aeropuertos SET ";
		$query .= " NOMBRE = '".$nombre."'";
		$query .= ", CIUDAD = '".$ciudad."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_aeropuertos WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $ciudad){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_aeropuertos (CODIGO, NOMBRE, CIUDAD) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
		$query .= "'".$ciudad."')";
	...
	function clsAeropuertos($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
