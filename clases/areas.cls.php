...
class clsAreas{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo ,nombre, visible_hits, visible_web
									  FROM hit_areas ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'AREAS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'AREAS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_areas'.$CADENA_BUSCAR);
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_areas WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $visible_hits, $visible_web){
		...
		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_areas (CODIGO, NOMBRE, VISIBLE_HITS, VISIBLE_WEB) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
		$query .= "'".$visible_hits."',";
		$query .= "'".$visible_web."')";
	...
	function clsAreas($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
