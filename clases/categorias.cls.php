...
class clsCategorias{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre
									  FROM hit_categorias ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'CATEGORIAS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'CATEGORIAS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_categorias'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre){
		...
		$conexion = $this ->Conexion;
		$query = "UPDATE hit_categorias SET ";
		$query .= " NOMBRE = '".$nombre."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_categorias WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre){
		...
		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_categorias (CODIGO, NOMBRE) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."')";
	...
	function clsCategorias($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
