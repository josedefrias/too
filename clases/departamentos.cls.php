...
class clsDepartamentos{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo, nombre, mail
									  FROM hit_departamentos ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'DEPARTAMENTOS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'DEPARTAMENTOS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_departamentos'.$CADENA_BUSCAR);
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_departamentos WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $mail){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_departamentos (CODIGO, NOMBRE, MAIL) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
		$query .= "'".$mail."')";
	...
	function clsDepartamentos($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
