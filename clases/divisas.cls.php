...
class clsDivisas{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo, nombre, codigo_corto
									  FROM hit_divisas ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'DIVISAS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'DIVISAS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_divisas'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $codigo_corto){

		$conexion = $this ->Conexion;
		$query = "UPDATE hit_divisas SET ";
		$query .= " NOMBRE = '".$nombre."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_divisas WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $codigo_corto){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_divisas (CODIGO, CODIGO_CORTO, NOMBRE) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$codigo_corto."',";
		$query .= "'".$nombre."')";
	...
	function clsDivisas($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
