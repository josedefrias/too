...
class clsEmpresas{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo ,nombre, tipo
									  FROM hit_empresas ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'EMPRESAS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'EMPRESAS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_empresas'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $tipo){

		$conexion = $this ->Conexion;
		$query = "UPDATE hit_empresas SET ";
		$query .= " NOMBRE = '".$nombre."'";
		$query .= ", TIPO = '".$tipo."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_empresas WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $tipo){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_empresas (CODIGO, NOMBRE, TIPO) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
		$query .= "'".$tipo."')";
	...
	function clsEmpresas($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
