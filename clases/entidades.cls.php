...
class clsEntidades{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre
									  FROM hit_entidades ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'ENTIDADES' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'ENTIDADES' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_entidades'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre){
		...
		$conexion = $this ->Conexion;
		$query = "UPDATE hit_entidades SET ";
		$query .= " NOMBRE = '".$nombre."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_entidades WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($nombre){
		...
		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_entidades (NOMBRE) VALUES (";
		//$query .= "'".$codigo."',";
		$query .= "'".$nombre."')";
	...
	function clsEntidades($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
