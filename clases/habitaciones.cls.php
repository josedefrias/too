...
class clsHabitaciones{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre,tipo_alojamiento
									  FROM hit_habitaciones ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'HABITACIONES' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'HABITACIONES' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_habitaciones'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $tipo_alojamiento){
		...
		$conexion = $this ->Conexion;
		$query = "UPDATE hit_habitaciones SET ";
		$query .= " NOMBRE = '".$nombre."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_habitaciones WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $tipo_alojamiento){
		...
		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_habitaciones (CODIGO, NOMBRE, TIPO_ALOJAMIENTO) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
	...
	function clsHabitaciones($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
