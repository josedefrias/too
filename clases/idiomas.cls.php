...
class clsIdiomas{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre
									  FROM hit_idiomas ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'IDIOMAS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'IDIOMAS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_idiomas'.$CADENA_BUSCAR);
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_idiomas WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre){
		...
		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_idiomas (CODIGO, NOMBRE) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."')";
	...
	function clsIdiomas($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
