...
class clsInterfaces{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT id, nombre, codigo, tipo, visible
									  FROM hit_interfaces ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'INTERFACES' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'INTERFACES' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_interfaces'.$CADENA_BUSCAR);
	...
	function Modificar($id, $nombre, $tipo, $visible){

		$conexion = $this ->Conexion;
		$query = "UPDATE hit_interfaces SET ";
		$query .= " NOMBRE = '".$nombre."'";
		$query .= ", TIPO = '".$tipo."'";
	...
	function Borrar($id){
		...
		$query = "DELETE FROM hit_interfaces WHERE ID = '".$id."'";
	...
	function Insertar($nombre, $codigo, $tipo, $visible){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_interfaces (NOMBRE, CODIGO, TIPO, VISIBLE) VALUES (";
		$query .= "'".$nombre."',";
		$query .= "'".$codigo."',";
		$query .= "'".$tipo."',";
		$query .= "'".$visible."')";
	...
	function clsInterfaces($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
