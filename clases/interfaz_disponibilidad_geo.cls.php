...
class clsInterfaz_disponibilidad_geo{
	...
	function Cargar(){
		...
		$buscar_longitud = $this->Buscar_longitud; 
		$buscar_latitud = $this->Buscar_latitud; 
		$buscar_radio_km = $this->Buscar_radio_km; 
		...
		if($buscar_interfaz == 'RESTEL'){
			...
			$xml2 .= "<longitud>".$buscar_longitud."</longitud>";
			$xml2 .= "<latitud>".$buscar_latitud."</latitud>";
			$xml2 .= "<radiopoblacion>".$buscar_radio_km."</radiopoblacion>";
			...
			$no_disp = $xml->parametros->hotls->attributes()->num;
			...
			for($i=0;$i<$no_disp;$i++)
			{
				...
				$dispo = $xml->parametros->hotls->hot[$i];
	...
	function clsInterfaz_disponibilidad_geo($conexion, $filadesde, $usuario, $buscar_interfaz, $buscar_pais, $buscar_provincia, $buscar_poblacion, $buscar_categoria, $buscar_fecha_entrada, $buscar_fecha_salida, $buscar_hotel, $buscar_habitaciones, $buscar_adultos, $buscar_ninos,
		$buscar_longitud, $buscar_latitud, $buscar_radio_km){
		...
		$this->Buscar_longitud = $buscar_longitud;
		$this->Buscar_latitud = $buscar_latitud;
		$this->Buscar_radio_km = $buscar_radio_km;
	}
}
