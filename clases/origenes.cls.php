...
class clsOrigenes{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre, visible
									  FROM hit_origenes ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'ORIGENES' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'ORIGENES' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_origenes'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $visible){

		$conexion = $this ->Conexion;
		$query = "UPDATE hit_origenes SET ";
		$query .= " NOMBRE = '".$nombre."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_origenes WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $visible){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_origenes (CODIGO, NOMBRE, VISIBLE) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
		$query .= "'".$visible."')";
	...
	function clsOrigenes($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
