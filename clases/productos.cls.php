...
class clsProductos{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre,visible,aplica_impuesto, aplica_impuesto_fuera
									  FROM hit_productos ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'PRODUCTOS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'PRODUCTOS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_productos'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $visible, $aplica_impuesto, $aplica_impuesto_fuera){

		$conexion = $this ->Conexion;
		$query = "UPDATE hit_productos SET ";
		$query .= " NOMBRE = '".$nombre."'";
		$query .= ", VISIBLE = '".$visible."'";
		$query .= ", APLICA_IMPUESTO = '".$aplica_impuesto."'";
		$query .= ", APLICA_IMPUESTO_FUERA = '".$aplica_impuesto_fuera."'";
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_productos WHERE CODIGO = '".$codigo."'";
		...
		$respuesta = 'No esta permitido borrar productos. Consulte con el administrador del sistema.';
		return $respuesta;											
	}

	function Insertar($codigo, $nombre, $visible, $aplica_impuesto, $aplica_impuesto_fuera){

		$conexion = $this ->Conexion;
		$query = "INSERT INTO hit_productos (CODIGO, NOMBRE, VISIBLE, APLICA_IMPUESTO, APLICA_IMPUESTO_FUERA) VALUES (";
		$query .= "'".$codigo."',";
		$query .= "'".$nombre."',";
		$query .= "'".$visible."',";
		$query .= "'".$aplica_impuesto."',";
		$query .= "'".$aplica_impuesto_fuera."')";
	...
	function clsProductos($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
