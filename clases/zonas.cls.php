...
class clsZonas{
	...
	function Cargar(){
		...
		$resultado =$conexion->query("SELECT codigo,nombre, destino, visible, visible_grupos
									  FROM hit_zonas ".$CADENA_BUSCAR." ORDER BY NOMBRE");
		...
		$numero_filas =$conexion->query("SELECT LINEAS_MODIFICACION FROM hit_usuarios_formularios WHERE FORMULARIO = 'ZONAS' AND USUARIO = '".$Usuario."'");
	...
	function Cargar_lineas_nuevas(){
		...
		$num_filas =$conexion->query("SELECT LINEAS_NUEVAS FROM hit_usuarios_formularios WHERE FORMULARIO = 'ZONAS' AND USUARIO = '".$Usuario."'");
		if ($num_filas == FALSE){
	...
	function Cargar_combo_selector(){
		...
		$resultadoc =$conexion->query('SELECT * FROM hit_zonas'.$CADENA_BUSCAR);
	...
	function Modificar($codigo, $nombre, $destino, $visible, $visible_grupos){
	...
	function Borrar($codigo){
		...
		$query = "DELETE FROM hit_zonas WHERE CODIGO = '".$codigo."'";
	...
	function Insertar($codigo, $nombre, $destino, $visible, $visible_grupos){
	...
	function clsZonas($conexion, $filadesde, $usuario, $buscar_codigo, $buscar_nombre){
