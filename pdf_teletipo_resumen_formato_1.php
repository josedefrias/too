...
$conexion = conexion_hit();
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
														...
														<!--<p>-->
															<a href='http://www.hitravel.es' target='_blank'>
																<!--<span style='text-decoration:none'>-->
																	<img src='imagenes/logos/".$cabecera_imagen."' alt='Canarias' border='0' width='820' height='300'>
																<!--</span>-->
															</a>
			...
			$respuesta .= "															</tbody>
						...
						if($cabecera_1 != ''){																			
							$respuesta .= "														<td style='padding:0cm 0cm 0.1cm 0cm;' align='center'>
																									<p style='margin:0cm;margin-bottom:.0001pt'>
																										<b>
		...
		$respuesta .= "																	</tr>";
			...
			for ($i = 0; $i < count($sHoteles); $i++) {		
				...
				$respuesta .= " 														<tr>
																							...
																							<td align='left' style='padding:0cm 0cm 0.1cm 0cm;font-weight:bold;font-size:".$tamano_fuente_hoteles.".0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;color:".$color_precios_nombre_hotel."'>".$sHoteles[$i]['nombre']."</td>	
																							<td align='center'style='font-weight:bold;font-size:".$tamano_fuente_hoteles.".0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;color:".$color_precios_categoria_hotel."'>".$sHoteles[$i]['categoria_3']."</td>
